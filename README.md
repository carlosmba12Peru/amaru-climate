...
[![AWS Bedrock](https://img.shields.io/badge/AWS_Bedrock-Nova_Lite_&_Claude_3.5-ff9900)](https://aws.amazon.com/bedrock/)
[![IEEE ClimateChain](https://img.shields.io/badge/IEEE_ClimateChain-Global_2026_(COP31)-blueviolet)](https://ieee-climatechain-hack.devpost.com/)
[![Web3 Climate Oracle](https://img.shields.io/badge/Web3-Climate_Oracle_EVM-purple)](#)
[![TRL](https://img.shields.io/badge/Maturity-TRL_7-green)](#)
[![Python](https://img.shields.io/badge/Python-3.11_|_3.14-brightgreen)](https://www.python.org/)
[![Tests](https://img.shields.io/badge/Tests-167%2F167_Passing_(100%25)-success)](#)
[![Official Doctrine](https://img.shields.io/badge/Official_Doctrine-46_Compiled_PDFs-navy)](#)
[![Telegram C2](https://img.shields.io/badge/Telegram_C2-Real_Time_Alerts-229ED9)](https://telegram.org/)
[![Law 31814](https://img.shields.io/badge/Human_Sovereignty-Law_N%C2%B0_31814-red)](#)
...
```mermaid
graph TD
    subgraph FUENTES ["Official Sources & Orbital Telemetry"]
        F1["SENAMHI (Severe Weather & GeoServer)"]
        F2["ENFEN / IMARPE (Technical PDF Bulletins)"]
        F3["NOAA CPC (sstoi.indices & Advisory)"]
        F4["IRI Columbia (Multi-Model Consensus)"]
        F5["GOES-19 Satellite (Channel 13 ABI & GLM)"]
        F6["IMARPE Satellite (SST, Chlorophyll & ASCAT)"]
        F7["Multichannel OSINT (TikTok Streams, Local Radio)"]
    end

    subgraph ORQUESTACION ["Central Sovereign Orchestrator"]
    ...
    subgraph CHIRI_SUB ["AMARU-CHIRI Subsystem (Highlands - Cold Phase)"]
        RELOJ_NINA["El Reloj de La Niña<br/>(April: Golden Window)"]
        ISH["ISH-CHIRI Index<br/>(27 Priority Districts)"]
        CRIO["Cryoclimatic Agent<br/>(Wind-Chill & Alpaca Health)"]
        PREVAED["PREVAED Directives<br/>(MINEDU / Adobe Schools)"]
        C2_CHIRI["C2 AMARU-CHIRI Console<br/>(Port 8502)"]
    end

    subgraph AWS_SUB ["AWS Cloud & Telegram Dispatch Layer"]
        BEDROCK["Amazon Bedrock us-east-1<br/>(Nova Lite & Claude 3.5)"]
        STRANDS["AWS Strands Agents SDK<br/>(11 Native Tools @tool)"]
        TG["Telegram Notifier<br/>(Finite State Machine - Law 31814)"]
